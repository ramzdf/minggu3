...
<div class="container tm-position-relative">
        ...
        <div class="row tm-welcome-content">
          ...
          <p class="gray-text tm-welcome-description">Hello Welcome to the Cafe <span class="gold-text">Saya Mohamad Zidfi Rohmatu Romadhon </span> adalah Mahasiswa Jurusan Teknologi prodi Manajemen Informatika <span class="gold-text"> di POLITEKNIK NEGERI MALANG (POLINEMA)</span>. 
          Saya berasal dari Desa Kembangbilo Tuban Jawa timur. </p>
